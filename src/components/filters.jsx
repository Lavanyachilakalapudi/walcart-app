                ...
                !filter?
                    ...
                    products && products.map((product,i)=>{
                        return (
                            ...
                            <h2 className="namehead"><Link to={`/item/${product._id}`}>{product.name}</Link></h2>
                            <h3 className="namehead">Product Price:{product.price}</h3>
                            <h3 className="namehead">Product seller:{product.seller}</h3>
                            </div>
                        )
                    }):
